...
public interface LoginDao {
	ProfissionalSaude fazerLogin(String login, String hashSenha) throws ErroLoginException;

	void salvar(Object medico);

	AccessToken buscarToken(String token) throws TokenNaoExisteException;
}
