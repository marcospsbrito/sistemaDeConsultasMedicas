...
public interface ExameDao {
	void salvar(Object medico);

	Exame consultarExameDoPaciente(String cpfPaciente, long codigoExame) throws ExameInexistenteParaOPacienteException;

	void deletarExame(long codigoExame) throws ExameInexistenteException;
}
